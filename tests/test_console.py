#!/usr/bin/python3
"""This script defines the unittests for the console.py.
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests class for testing exiting from the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests class for testing create from the HBNB command interpreter."""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests class for testing destroy from the HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unittests class for testing all of the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests class for testing changes from the HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """The class for Unittests count method of HBNB comand interpreter."""
